        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-2 justify-center">
                <div className="flex items-center gap-1.5">
                    <div className="w-6 h-6 rounded-full bg-foreground text-background text-xs font-semibold flex items-center justify-center">
                        1
                    </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Start managing inspections today. Free to get started.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <RegisterForm />
